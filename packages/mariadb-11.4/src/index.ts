...
export const DATABASE_VERSION = '11.4.5'
export const MAJOR_VERSION = '11.4'
...
const PLATFORM_PACKAGE_MAP: Record<Platform, string> = {
  'linux-x64': '@host-db/mariadb-11.4-linux-x64',
  'linux-arm64': '@host-db/mariadb-11.4-linux-arm64',
  'darwin-arm64': '@host-db/mariadb-11.4-darwin-arm64',
  'win32-x64': '@host-db/mariadb-11.4-win32-x64',
}
  ...
  try {
    ...
    throw new Error(
      `Platform package ${packageName} not found. ` +
        ...
        `Try reinstalling: npm install @host-db/mariadb-11.4`,
    )
  }
