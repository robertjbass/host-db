...
export const DATABASE_VERSION = '17.2'
export const MAJOR_VERSION = '17'
...
const PLATFORM_PACKAGE_MAP: Record<Platform, string> = {
  'linux-x64': '@host-db/postgresql-17-linux-x64',
  'linux-arm64': '@host-db/postgresql-17-linux-arm64',
  'darwin-arm64': '@host-db/postgresql-17-darwin-arm64',
  'win32-x64': '@host-db/postgresql-17-win32-x64',
}
  ...
  try {
    ...
    throw new Error(
      `Platform package ${packageName} not found. ` +
        ...
        `Try reinstalling: npm install @host-db/postgresql-17`,
    )
  }
