...
const CONFIG = {
  ...
  majorVersion: '8.4',
  platform: 'win32-x64',
  downloadUrl: 'https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-8.4.3-winx64.zip',
  ...
  binaries: [
    ...
    "bin\\\\mysqldump.exe",
    "bin\\\\mysqlcheck.exe",
    "bin\\\\mysqld --initialize-insecure.exe",
...
async function main() {
  ...
  const serverBinary = join(binDir, 'bin/mysqld.exe')
