...
export const DATABASE_VERSION = '7.2.7'
export const MAJOR_VERSION = '7.2'
...
const PLATFORM_PACKAGE_MAP: Record<Platform, string> = {
  'linux-x64': '@host-db/redis-7.2-linux-x64',
  'linux-arm64': '@host-db/redis-7.2-linux-arm64',
  'darwin-arm64': '@host-db/redis-7.2-darwin-arm64',
  'win32-x64': '@host-db/redis-7.2-win32-x64',
}
  ...
  try {
    ...
    throw new Error(
      `Platform package ${packageName} not found. ` +
        ...
        `Try reinstalling: npm install @host-db/redis-7.2`,
    )
  }
